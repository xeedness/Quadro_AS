...
#define MPU9250
#include "util.h"
#define i2c_write(a, b, c, d) sendPacketTwi1(a, b, c, d)
#define i2c_read(a, b, c, d)  receivePacketTwi1(a, b, c, d)
#define delay_ms  util_delay_ms
#define get_ms    util_get_clock_ms
#define log_i     util_log
#define log_e     util_log
